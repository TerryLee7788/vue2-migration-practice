<template>
  <div id="app" class="min-h-screen bg-surface font-sans text-ink">
    <header class="bg-brand-dark px-6 py-4 text-white">
      <h1 class="mb-3 text-xl">Vue 2 → Vue 3 遷移練習場</h1>
      <nav>
        <router-link to="/" class="nav-link" exact-active-class="text-brand">首頁</router-link>
        <router-link to="/products" class="nav-link" exact-active-class="text-brand">商品</router-link>
        <router-link to="/cart" class="nav-link" exact-active-class="text-brand">購物車 ({{ cartCount }})</router-link>
        <router-link to="/form" class="nav-link" exact-active-class="text-brand">表單</router-link>
        <router-link to="/quote" class="nav-link" exact-active-class="text-brand">試算</router-link>
      </nav>
    </header>
    ...
    <footer class="p-6 text-center text-subtle">
